...
export default function useOntologyGraph({
  ...
  useEffect(() => {
    ...
    const url =
      'https://wobr.caltech.edu/~azurebrd/cgi-bin/soba.cgi?action=annotSummaryJsonp&showControlsFlag=0&fakeRootFlag=0&filterForLcaFlag=1&filterLongestFlag=1&maxNodes=0&' +
      stringify(query);
