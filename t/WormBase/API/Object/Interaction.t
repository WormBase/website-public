#t/WormBase/API/Object/Interaction.t
...
## list test_objects 
my $test_objects = ["WBInteraction0000779"];

BEGIN {
      use_ok($WormBase::Test::API::Object::OBJECT_BASE . '::Interaction'); ## "::$class"
} # Interaction.t loads ok
