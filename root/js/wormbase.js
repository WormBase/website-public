  ...
  var issue = {
   ...
   submit:function(is){
       ...
       content += (dc && $jq.trim(dc.val())  ? '<p>What were you doing? <br />&nbsp;&nbsp;' + dc.val() + '</p>': '');
        ...
        addNewLink.show();
        message.append("<p><h2 style='color:rgb(95, 112, 137);'>Thank you for helping WormBase!</h2></p><p>The WormBase helpdesk will get back to you shortly. Please email <a href='mailto:help\@wormbase.org'>help\@wormbase.org</a> if you have any concerns.</p>");
        return false;
   },
