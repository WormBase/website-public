...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{TEST_APP_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{TEST_APP_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
wormbase_server.pl - Catalyst Testserver

=head1 SYNOPSIS

test_app_server.pl [options]
