...
has 'tracks' => (
    ...
    default => sub {
        return {
            ...
            data        => [qw/PRIMARY_GENE_TRACK RNASEQ_ASYMMETRIES RNASEQ RNASEQ_SPLICE POLYSOMES MICRO_ORF DNASEI_HYPERSENSITIVE_SITE REGULATORY_REGIONS PROMOTER_REGIONS HISTONE_BINDING_SITES TRANSCRIPTION_FACTOR_BINDING_REGION TRANSCRIPTION_FACTOR_BINDING_SITE GENOME_SEQUENCE_ERROR_CORRECTED BINDING_SITES_PREDICTED BINDING_SITES_CURATED BINDING_REGIONS GENOME_SEQUENCE_ERROR/],
        };
    }
);
