...
sub _build_tracks {
	...
	@tracks = qw(PRIMARY_GENE_TRACK CLASSICAL_ALLELES HIGH_THROUGHPUT_ALLELES POLYMORPHISMS CHANGE_OF_FUNCTION_ALLELES CHANGE_OF_FUNCTION_POLYMORPHISMS TRANSPOSON_INSERTION_SITES MILLION_MUTATION_PROJECT);
