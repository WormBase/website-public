...
sub gene_models {
  ...
  my $object = $self->current_object;
  my $stash  = {};
  my $sequences = $self->_fetch_sequences($object);
...
=item $self->genomic_position($object)
 ...
 Widget  : location
 Tmpl    : gene/genomic_position.tt2
...
=item $self->fourd_expression_movies($object)
 ...
 Widget  : expression
 Tmpl    : gene/fourd_expression_movies.tt2
...
=item $self->y1h_and_y2h_interactions($object)
 ...
 Widget  : function
 Tmpl    : gene/y1h_and_y2h_interactions.tt2
...
=item $self->microarray_expression_data($object)
 ...
 Widget  : function
 Tmpl    : gene/microarray_expression_data.tt2
...
=item $self->expression_cluster($object)
 ...
 Widget  : function
 Tmpl    : gene/expression_cluster.tt2
 TODO    : Check template.  Could be suitably generic. Just a table.
...
=item $self->microarray_topology_map_position($object)
 ...
 Widget  : function
 Tmpl    : gene/microarray_topology_map_position.tt2
 TODO    : Check template.
...
=item $self->regulation_on_expression_level($object)
 ...
 Widget  : function
 Tmpl    : gene/regulation_on_expression_level.tt2
 TODO    : Check template.
