...
if  (!$rss) {
	...
	foreach ( $all_items as $item ) {
		...
		if ($desc < 0) {
			...
			$str.= "document.write('<li class=\"rss-item\"><a class=\"rss-item\" href=\"" . trim($my_url) . "\" title=\"$title_str\"". $target_window . '>' . $my_title . "</a> ');";
