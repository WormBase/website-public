...
<html xmlns="http://www.w3.org/1999/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '><head>
	...
	echo '
	<!-- WormBase custom configuration; carry during upgrades! -->
	<STYLE type="text/css">
	...
	.binactive		{ color: #FFFFFF;
	  ...
	  A.bactive		  {  color:				#FFFF99;
								background-color: #b4cbdb;
								font-size: 13pt;  /* was 16 */
								text-align: center;
								text-decoration:none;
					  }			 
		A:hover.bactive  {  text-decoration:underline;  }
...
<tr>
<td bgcolor="#b4cbdb" align="center" style="cursor:hand;" nowrap onClick="c(\'http://www.wormbase.org/forums/\')">
			  <a href="http://www.wormbase.org/forums/" class="bactive"><b>Forum Home</b></a></td>
<td bgcolor="#5870a3" align="center" style="cursor:hand;" nowrap onClick="c(\'http://www.wormbase.org/\')">
			  <a href="http://www.wormbase.org/" class="binactive">WormBase</a></td>
<td bgcolor="#5870a3" align="center" style="cursor:hand;" nowrap onClick="c(\'http://www.wormatlas.org/\')">
			  <a href="http://www.wormatlas.org" class="binactive">WormAtlas</a></td>
<td bgcolor="#5870a3" align="center" style="cursor:hand;" nowrap onClick="c(\'http://www.wormbook.org/\')">
			  <a href="http://www.wormbook.org/" class="binactive">WormBook</a></td>
</tr>
</table>';
...
function template_main_below()
{
	...
	echo '
<script src="http://www.google-analytics.com/urchin.js" type="text/javascript"></script><script type="text/javascript">_uacct = "UA-2587143-1"; _udn="wormbase.org" ; urchinTracker();</script>
